...
function editRow(id) {
    ...
    document.getElementById('editMontantNette').value = cells[6].textContent;
    document.getElementById('editCompetition').value = cells[7].textContent;
    document.getElementById('editNiveauCompetition').value = cells[8].textContent;
...
function submitEditForm() {
  ...
  document.getElementById('editForm').style.display = 'none';
    ...
    if (isNaN(editMontantNette)) {
        alert("Le montant net doit être un nombre.");
        return false;
    }
...
?>
        ...
        <div class="form-container" id="addForm" style="display: none;">
            <h2>Ajouter un gagnant</h2>
             <form id="actualAddForm" method="POST" action="insert_mark.php">
    ...
    <?php endif; ?>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="bigint" id="cin" name="cin" required>
                    </div>
                    <div class="form-group">
