...
if (!isset($_SESSION['username'])) {
    header("Location: cnxlogin.php"); // Rediriger vers la page de connexion si l'utilisateur n'est pas connecté
    exit();
}
...
if (isset($_GET['logout'])) {
    ...
    header("Location: cnxlogin.php"); // Rediriger vers la page de connexion après la déconnexion
    exit();
}
?>
<!DOCTYPE html>
...
function editRow(id) {
    ...
    document.getElementById('editValeur').value = cells[5].textContent;
    document.getElementById('editDeduction').value = cells[6].textContent;
    document.getElementById('editMontantNette').value = cells[7].textContent;
    document.getElementById('editCompetition').value = cells[8].textContent;
    document.getElementById('editSituation').value = cells[9].textContent;
    document.getElementById('editDateKhalass').value = cells[10].textContent;
    document.getElementById('editCheque').value = cells[11].textContent;
    document.getElementById('editBanque').value = cells[12].textContent;
    document.getElementById('editEtatEnvoiExpert').value = cells[13].textContent;
    document.getElementById('editRDV').value = cells[14].textContent;
    document.getElementById('editCompte').value = cells[15].textContent;
    document.getElementById('editAnneeComptable').value = cells[16].textContent;
 ...
 function deleteRow(id) {
    ...
    var editCompetition = document.getElementById("editCompetition").value;
    var editSituation = document.getElementById("editSituation").value;
    var editDateKhalass = document.getElementById("editDateKhalass").value;
    var editCheque = document.getElementById("editCheque").value;
    var editBanque = document.getElementById("editBanque").value;
    var editEtatEnvoiExpert = document.getElementById("editEtatEnvoiExpert").value;
...
function validateAddForm() {
    ...
    var etatEnvoiExpert = document.getElementById("etat_envoi_expert").value;
    var rdv = document.getElementById("rdv").value;
    var compte = document.getElementById("compte").value;
    var anneeComptable = document.getElementById("annee_comptable").value;

    if (date === "" || numeroAppel === "" || nomPrenom === "") {
        alert("Veuillez remplir tous les champs obligatoires.");
        return false;
    }
...
<div class="form-container" id="addForm" style="display: none;">
    ...
    <form id="actualAddForm" method="POST" action="insert_fin.php">
        ...
        <div class="form-row">
            <div class="form-group">
                <label for="cin">عدد بطاقة التعريف الوطنية:</label>
...
<div class="edit-form" id="editForm" style="display: none;">
    ...
    <form action="update_fin.php" method="post">
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                <label for="editEtatEnvoiExpert">État d'envoi à l'expert:</label>
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                <button type="submit" onclick="return validateEditForm()">Enregistrer</button>
